...
describe('LibFecha ', function () {
  ...
  it('getYMDFromDate - fecha simple', function () {
    const d = new Date(2000, 0, 30);
    const fymd = LibFecha.getYMDFromDate(d);
  ...
  it('getDateFromAddDays - agregar 1 dias as 2019-05-20 ', function () {
    ...
    const fnew = LibFecha.getYMDFromDate(newDate);
  ...
  it('getFechaFromTS - obtener fecha a aprtir de un TZ ', function () {

    const fnew = LibFecha.getFechaFromTS(1582757161 * 1000);

    assert('26/02/2020' === fnew, ` recibio ${fnew}`);
  });
